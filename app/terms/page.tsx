  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 py-4">
      ...
      <Section title="第5条（免責事項）">
        <ul>
          <li>AIによる解析結果（日付・金額・勘定科目等）はあくまで補助的なものであり、正確性を保証しません。必ず内容をご自身で確認した上でご利用ください。</li>
          <li>当サービスは確定申告の代行・税務および会計に関する専門的アドバイスを提供するものではありません。申告については税理士・公認会計士等の専門家にご相談ください。</li>
          <li>当サービスの利用に起因する確定申告の内容・税務調査の結果・追徴課税その他の税務上の不利益について、当サービスは一切の責任を負いません。</li>
          ...
          <li>ユーザーがアップロードした画像・入力したデータの正確性・合法性についてはユーザー自身が責任を負います。不正確な情報や第三者の権利を侵害するデータを入力した場合の損害についても当サービスは責任を負いません。</li>
        </ul>
      </Section>
